...
export default function HomeV4() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <a href="/v4" className="text-primary-400 font-semibold text-sm">V4</a>
              <a href="/v5" className="text-slate-400 hover:text-primary-400 transition-colors font-medium text-sm">V5</a>
      ...
      {/* Hero Section - DARK */}
      <section id="hero" className="pt-28 pb-32 md:pb-40 bg-gradient-to-br from-slate-900 via-[#0a0e1a] to-primary-950 relative overflow-hidden">
      ...
      <section id="about" className="py-32 md:py-40 bg-white relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            <p className="text-sm md:text-base text-primary-600 uppercase tracking-wider font-semibold mb-4">
              About Us
            </p>
          ...
          <div className="space-y-6 text-lg text-slate-700 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-primary-50 to-secondary-50 p-8 rounded-lg shadow-lg border-2 border-primary-200 my-8">
              <p className="text-xl font-semibold text-slate-900 mb-6">Our belief is straightforward:</p>
      ...
      {/* Services Section - VERY DARK */}
      <section id="services" className="py-32 md:py-40 bg-gradient-to-br from-[#020305] via-[#050810] to-[#020305] relative overflow-hidden">
        <div className="absolute top-40 left-10 w-72 h-72 bg-secondary-500/20 rounded-full blur-3xl"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Service 1 */}
            <div className="bg-gradient-to-br from-slate-800/90 to-slate-900/90 p-8 rounded-lg border-2 border-primary-500/50 hover:border-primary-400/80 hover:shadow-2xl hover:shadow-primary-500/40 transition-all">
            ...
            {/* Service 2 */}
            <div className="bg-gradient-to-br from-slate-800/90 to-slate-900/90 p-8 rounded-lg border-2 border-secondary-500/50 hover:border-secondary-400/80 hover:shadow-2xl hover:shadow-secondary-500/40 transition-all">
      ...
      {/* People Development Section - VERY LIGHT */}
      <section className="py-32 md:py-40 bg-gradient-to-br from-slate-50 via-primary-50 to-slate-100 relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <p className="text-xl md:text-2xl text-slate-800 leading-relaxed text-center font-medium">
            ...
            <div className="bg-white p-10 rounded-2xl border-2 border-primary-300 shadow-xl space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6 pt-4">
                <div className="space-y-3">
                  <div className="flex items-start">
                    ...
                    <span className="text-slate-800">Leadership coaching and capability building</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-primary-600 mr-3 text-xl font-bold">→</span>
                    <span className="text-slate-800">Team development and continuous learning</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-primary-600 mr-3 text-xl font-bold">→</span>
                    <span className="text-slate-800">Kanban and flow-based delivery training</span>
                  </div>
                </div>
                <div className="space-y-3">
                  <div className="flex items-start">
                    <span className="text-primary-600 mr-3 text-xl font-bold">→</span>
                    <span className="text-slate-800">Operating model and delivery practice uplift</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-primary-600 mr-3 text-xl font-bold">→</span>
                    <span className="text-slate-800">Building confidence through clarity and coaching</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-primary-600 mr-3 text-xl font-bold">→</span>
                    <span className="text-slate-800">Creating sustainable learning cultures</span>
                  </div>
                </div>
              </div>

              <p className="text-lg text-slate-700 leading-relaxed italic pt-4 border-t-2 border-primary-200">
      ...
      {/* About Rebecca Section - VERY DARK */}
      <section id="rebecca" className="py-32 md:py-40 bg-gradient-to-br from-[#020305] via-[#0a0520] to-[#020305] relative overflow-hidden">
        <div className="absolute top-10 right-20 w-80 h-80 bg-primary-500/15 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 left-20 w-64 h-64 bg-secondary-500/15 rounded-full blur-3xl"></div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="bg-slate-800/80 p-8 md:p-12 rounded-lg shadow-2xl border-2 border-primary-500/40">
      ...
      {/* Footer */}
      <footer className="bg-slate-900 border-t border-slate-700 text-slate-400 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
